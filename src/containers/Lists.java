...
public class Lists {
	...
	public static void basicTest(List<String> a) {
		...
		// Lists allow random access,which is cheap for ArrayList,expensive for
		// linked for LinkedList
		...
		// Keep everything that's in the argument (the intersection of the two
		// sets)
	...
	public static void testLinkedList() {
		...
		// Like "peeking" at the top of the stack
		print(ll.getFirst());
